        ...
        <ScrollArea className="h-[60vh] px-6 pb-6">
          <div className="space-y-4 font-body text-cream-muted">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Para questões relacionadas com a privacidade dos seus dados, contacte-nos através de info@mpgrupo.pt ou +351 928 203 793 (chamada para a rede móvel nacional).
              </p>
            </section>
